...
/**
 *  Failure handling with status/status code. Old technique.
 */
class AccountOld {
    private int acno;
    ...
    /**
     * returns 0 for success, 1 - insufficient funds, 2 - data error
     */
...
public class ExceptionHandlingEx2 {
    public static void main(String[] args) {
        ...
        switch(withdrawStatus) {
            case SUCCESS: System.out.println("withdraw success");
                          break;
            case INSUFFICIENT_FUNDS:
                          System.out.println("failed with insufficient funds");
                          break;
            case DATA_ERROR:
